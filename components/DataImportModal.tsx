...
interface DataImportModalProps {
  ...
  onClose: () => void;
  products: Product[];
  onImport: (updates: CsvUpdatePayload[]) => void;
}
...
const DataImportModal: React.FC<DataImportModalProps> = ({ isOpen, onClose, products, onImport }) => {
